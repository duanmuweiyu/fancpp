...
static inline void cf_FileOutputStream_make(cf_FileOutputStream *self, FILE *file) {
  self->file = file;
...
static inline void cf_FileInputStream_make(cf_FileInputStream *self, FILE *file) {
  self->file = file;
